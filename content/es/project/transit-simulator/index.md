---
title: Simulador de Tránsitos Planetarios
summary: Simulador interactivo físicamente inspirado que modela la disminución de brillo estelar cuando un exoplaneta transita frente a su estrella.
tags:
  - Divulgación
  - Educación
  - Interactivos
...
# Enlace al simulador directamente
links:
  - icon: external-link-alt
    name: Ver Simulador Completo
    url: /simuladores/transito/transito.html
  - icon: book-open
    name: Leer Artículo en el Blog
    url: /es/blog/transitos/
---
...
2. Explorar cómo tránsitos rasantes (baja inclinación orbital) modifican la forma de la curva de luz convirtiendo la clásica forma en "U" en una "V".
3. Analizar la importancia del oscurecimiento de borde en la caracterización estelar y el ajuste de modelos de exoplanetas.
